...
public partial class MetaCodeBaseListener : IMetaCodeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterReturnStatement([NotNull] MetaCodeParser.ReturnStatementContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MetaCodeParser.returnStatement"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitReturnStatement([NotNull] MetaCodeParser.ReturnStatementContext context) { }
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterAttributeDeclaration([NotNull] MetaCodeParser.AttributeDeclarationContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MetaCodeParser.attributeDeclaration"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitAttributeDeclaration([NotNull] MetaCodeParser.AttributeDeclarationContext context) { }
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterMemberTagExpression([NotNull] MetaCodeParser.MemberTagExpressionContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MetaCodeParser.memberTagExpression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitMemberTagExpression([NotNull] MetaCodeParser.MemberTagExpressionContext context) { }
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterObjectDeclaration([NotNull] MetaCodeParser.ObjectDeclarationContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MetaCodeParser.objectDeclaration"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitObjectDeclaration([NotNull] MetaCodeParser.ObjectDeclarationContext context) { }
